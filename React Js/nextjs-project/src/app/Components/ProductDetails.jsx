                    ...
                    <>
                        ...
                        >
                            <div class="container mx-auto px-4">
                                <img
                                    class="w-full"
                                    src={productDetails.multiple_images[0]}
                                    alt="Sofa image"
                                />
                            ...
                            <div class="mx-auto px-5 lg:px-5">
                                <h2 class="pt-3 text-2xl font-bold lg:pt-0">{productDetails.name}</h2>
                                <div class="mt-1">
                                ...
                                <p class="font-bold">Brand: <span class="font-normal">{ productDetails.brand }</span></p>
                                <p class="font-bold">
                                    Category: <span class="font-normal">{productDetails.category}</span>
                                </p>
                                <p class="font-bold">
                                ...
                                <p class="mt-4 text-4xl font-bold text-violet-900">
                                    ${productDetails.price} <span class="text-xs text-gray-400 line-through">$550</span>
                                </p>
